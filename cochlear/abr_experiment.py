...
from neurogen.block_definitions import Tone, Cos2Envelope, BandlimitedNoise
from neurogen.calibration import Attenuation
#from nidaqmx import TriggeredDAQmxSource, DAQmxSink, DAQmxAttenControl
...
#from cns.chaco_exts.epoch_channel_plot import EpochChannelPlot
...
#            n = self.model.data.current_channel.get_n(threshold)
#            if n > self.get_current_value('averages'):
#                self.done = True
        ...
        menubar=MenuBar(
            ...
            Menu(
                ...
                ActionGroup(
                    ...
                    Action(name='Calibrate speakers',
                           action='calibrate_speakers'),
                ),
                name='&Calibration'
            ),
